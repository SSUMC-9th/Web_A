      ...
      <nav className="sticky top-0 z-10 w-full bg-zinc-900/90 backdrop-blur px-4">
        <div className="mx-auto max-w-5xl h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/login"
              className={`h-8 px-3 rounded-md text-sm font-medium border border-zinc-700 bg-zinc-800 hover:bg-zinc-700 transition-colors ${
            ...
            <Link
              to="/signup"
              className={`h-8 px-3 rounded-md text-sm font-medium bg-pink-600 hover:bg-pink-500 transition-colors ${
