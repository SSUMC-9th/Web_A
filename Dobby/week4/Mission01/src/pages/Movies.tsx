...
import { fetchByCategory, type Movie, tmdbImg } from "../api/tmdb";
...
export default function Movies() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetchByCategory("popular", 1)
      .then((data: { results: Movie[] }) => setItems(data.results))
      .catch((e: Error) => !ac.signal.aborted && setError(e.message))
