    ...
    return (
        <div className="h-dvh flex flex-col bg-gray-900 text-white">
            ...
            <button
                ...
                aria-label="add lp"
                className="fixed bottom-6 right-6 w-12 h-12 flex items-center justify-center leading-none rounded-full bg-pink-500 text-white text-2xl shadow-lg hover:scale-105 active:scale-95" // 왜 가운데로 안 오지 ㅜㅜ
            >
                +
            </button>
